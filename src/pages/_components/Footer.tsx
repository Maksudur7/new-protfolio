...
export default function Footer() {
  const { data: footerData, isLoading } = useGlobal("footer-section");

  if (isLoading) {
    return (
      <footer className="text-foreground border-t border-border py-12 flex justify-center items-center min-h-[300px]">
            ...
            <div className="flex items-center gap-3 text-foreground">
              ...
              <div>
                ...
                <p className="font-medium text-foreground">
                  {footerData?.email || "maksudurrahamanmishu7@gmail.com"}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3 text-foreground">
              ...
              <div>
                ...
                <a
                  href={footerData?.githubUrl || "https://github.com/Maksudur7"}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-medium text-primary hover:text-accent transition-colors"
                >
                  {footerData?.githubLabel || "github.com/Maksudur7"}
                </a>
              </div>
            </div>
            <div className="flex items-center gap-3 text-foreground">
              ...
              <div>
                ...
                <a
                  href={
                    ...
                    "https://www.linkedin.com/in/maksudur-rahaman"
                  }
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-medium text-primary hover:text-accent transition-colors"
        ...
        <div className="mt-10 border-t border-border pt-6 flex flex-col gap-4 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>
            ...
            {footerData?.copyrightText ||
              "Maksudur Rahaman. Designed with a polished dark + white theme."}
          </p>
