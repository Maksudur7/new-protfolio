...
export default function Experience() {
  ...
  const {
    data: cmsExperiencesData,
    isLoading,
    isError,
  } = useCollection("experiences", "limit=100&sort=order");

  const rawExperiences = cmsExperiencesData?.docs || [];

  const experiences: ExperienceItem[] = rawExperiences.map((doc: any) => ({
    id: doc.id,
    icon: doc.icon || "💼",
    title: doc.title,
    company: doc.company,
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full">
        ...
        <div className="mb-10 space-y-4">
          ...
          {isError && (
            <div className="inline-flex items-center gap-2 text-xs text-red-500/80">
